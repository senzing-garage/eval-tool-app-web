export interface SzEngine {
    ...
    findNetworkByEntityId(entityIds: Array<number>, maxDegrees: number, buildOutDegrees: number, buildOutMaxEntities: number, flags: number): void;
    findNetworkByRecordId(recordId: Array<[string, number]>, maxDegrees: number, buildOutDegrees: number, buildOutMaxEntities: number, flags: number): void;
    findPathByEntityId(startEntityId: number, endEntityId: number, maxDegrees: number, avoidEntityIds: Array<number>, requiredDataSources: Array<string>, flags: number): void;
    findPathByRecordId(startDataSourceCode: string, startRecordId: string, endDataSourceCode: string, endRecordId: string, maxDegrees: number, avoidRecordKeys: Array<[string, number]>, requiredDataSources: Array<string>, flags: number): void;
    ...
    searchByAttributes(attributes: string, flags: number, searchProfile: string): void;
    whyEntities(entityId1: number, entityId2: number, flags: number): void;
    whyRecordInEntity(dataSourceCode: string, recordId: string, flags: number): void;
    whyRecords(dataSourceCode1: string, recordId1: string, dataSourceCode2: string, recordId2: string, flags: number): void;
}
