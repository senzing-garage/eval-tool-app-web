...
exports.SzGrpcWebEngine = void 0;
const szengine_web_pb_1 = require("./szengine/szengine_web_pb");
...
const senzing_1 = require("./senzing");
 ...
 * @hideconstructor
 */
class SzGrpcWebEngine extends szGrpcWebBase_1.SzGrpcWebBase {
    /**
    ...
    constructor(parameters) {
        ...
        if (client) {
            ...
            this._client = new szengine_web_client_1.SzEngineClient(connectionString ? connectionString : szGrpcWebEnvironment_1.DEFAULT_CONNECTION_STRING, credentials ? credentials : szGrpcWebEnvironment_1.DEFAULT_CREDENTIALS, grpcOptions ? grpcOptions : szGrpcWebEnvironment_1.DEFAULT_CHANNEL_OPTIONS);
        }
        else {
     ...
     */
    addRecord(dataSourceCode, recordId, recordDefinition, engineFlags = 0) {
        let recordPayload;
        ...
        try {
            let _parses = JSON.parse(recordDefinition);
            recordPayload = recordDefinition;
        }
        catch (err) {
            // throw? or log??
        }
        return new Promise(async (resolve, reject) => {
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.AddRecordRequest();
                request.setDataSourceCode(dataSourceCode);
                request.setRecordId(recordId);
                request.setRecordDefinition(recordPayload);
                request.setFlags((0, szHelpers_1.bigIntToNumber)(engineFlags));
                this.client.addRecord(request, this._metadata, (err, res) => {
                    if (err) {
     ...
     */
    closeExportReport(exportHandle) {
        return new Promise((resolve, reject) => {
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.CloseExportReportRequest();
                request.setExportHandle(exportHandle);
                this.client.closeExportReport(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
    ...
    countRedoRecords() {
        return new Promise((resolve, reject) => {
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.CountRedoRecordsRequest();
                this.client.countRedoRecords(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
     ...
     * @returns {Promise<string>}
     */
    deleteRecord(dataSourceCode, recordId, flags = 0) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.DeleteRecordRequest();
                request.setDataSourceCode(dataSourceCode);
                request.setRecordId(recordId);
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.deleteRecord(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
    ...
    exportCsvEntityReport() {
        return new Promise(async (resolve, reject) => {
            reject(new SzError_1.SzNotYetImplementedError());
        });
    }
    /** NOT YET IMPLEMENTED */
     ...
     * recursive function maybe? promises are async so there's no guarantee that one will finish before the next.
     */
    exportJsonEntityReport(flags = senzing_1.SzEngineFlags.SZ_EXPORT_DEFAULT_FLAGS) {
    }
    /**
     * NOT YET IMPLEMENTED
     ...
     */
    exportJsonEntityReportIterator(flags = senzing_1.SzEngineFlags.SZ_EXPORT_DEFAULT_FLAGS) {
        return new Promise(async (resolve, reject) => {
            reject(new SzError_1.SzNotYetImplementedError());
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                if (err) {
     ...
     * @returns {Promise<string>}
     */
    findInterestingEntitiesByEntityId(entityId, flags = senzing_1.SzEngineFlags.SZ_ENTITY_DEFAULT_FLAGS) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.FindInterestingEntitiesByEntityIdRequest();
                request.setEntityId(entityId);
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.findInterestingEntitiesByEntityId(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
     ...
     * @returns {Promise<string>}
     */
    findInterestingEntitiesByRecordId(dataSourceCode, recordId, flags = 0) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.FindInterestingEntitiesByRecordIdRequest();
                request.setDataSourceCode(dataSourceCode);
                request.setRecordId(recordId);
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.findInterestingEntitiesByRecordId(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
     ...
     */
    findNetworkByEntityId(entityIds, maxDegrees, buildOutDegrees, buildOutMaxEntities, flags = senzing_1.SzEngineFlags.SZ_FIND_NETWORK_DEFAULT_FLAGS) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            }
            let findNetworkEntityIds = (0, szHelpers_1.entityIdsAsJsonString)(entityIds);
            if (!findNetworkEntityIds) {
                ...
                this.waitForReady(this.getDeadlineFromNow(), (err) => {
                    ...
                    const request = new szengine_web_pb_1.FindNetworkByEntityIdRequest();
                    request.setEntityIds(findNetworkEntityIds);
                    if (maxDegrees) {
                        request.setMaxDegrees(maxDegrees);
                    }
                    if (buildOutDegrees) {
                        request.setBuildOutDegrees(buildOutDegrees);
                    }
                    if (buildOutMaxEntities) {
                        request.setBuildOutMaxEntities(buildOutMaxEntities);
                    }
                    request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                    this.client.findNetworkByEntityId(request, this._metadata, (err, res) => {
                        if (err) {
                            let _err = (0, szHelpers_1.newException)(err);
                            reject(_err);
                            throw _err;
     ...
     * @returns {Promise<string>} A JSON document.
     */
    findNetworkByRecordId(recordKeys, maxDegrees, buildOutDegrees, buildOutMaxEntities, flags = senzing_1.SzEngineFlags.SZ_FIND_NETWORK_DEFAULT_FLAGS) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            }
            let findNetworkRecordIds = (0, szHelpers_1.recordIdsAsJsonString)(recordKeys);
            if (!findNetworkRecordIds) {
                ...
                this.waitForReady(this.getDeadlineFromNow(), (err) => {
                    ...
                    const request = new szengine_web_pb_1.FindNetworkByRecordIdRequest();
                    ...
                    request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                    this.client.findNetworkByRecordId(request, this._metadata, (err, res) => {
                        if (err) {
                            let _err = (0, szHelpers_1.newException)(err);
                            reject(_err);
                            throw _err;
     ...
     */
    findPathByEntityId(startEntityId, endEntityId, maxDegrees, avoidEntityIds, requiredDataSources, flags = senzing_1.SzEngineFlags.SZ_FIND_PATH_DEFAULT_FLAGS) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.FindPathByEntityIdRequest();
                request.setStartEntityId(startEntityId);
                request.setEndEntityId(endEntityId);
                request.setMaxDegrees(maxDegrees);
                if (avoidEntityIds) {
                    request.setAvoidEntityIds((0, szHelpers_1.entityIdsToAvoidAsJson)(avoidEntityIds));
                }
                if (requiredDataSources) {
                    request.setRequiredDataSources((0, szHelpers_1.requiredDataSourcesAsJson)(requiredDataSources));
                }
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.findPathByEntityId(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
     ...
     * @returns {Promise<string>} A JSON document.
     */
    findPathByRecordId(startDataSourceCode, startRecordId, endDataSourceCode, endRecordId, maxDegrees, avoidRecordKeys, requiredDataSources, flags = senzing_1.SzEngineFlags.SZ_FIND_PATH_DEFAULT_FLAGS) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.FindPathByRecordIdRequest();
                ...
                request.setMaxDegrees(maxDegrees);
                if (avoidRecordKeys) {
                    request.setAvoidRecordKeys((0, szHelpers_1.recordKeysToAvoidAsJson)(avoidRecordKeys));
                }
                if (requiredDataSources) {
                    request.setRequiredDataSources((0, szHelpers_1.requiredDataSourcesAsJson)(requiredDataSources));
                }
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.findPathByRecordId(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
    ...
    getActiveConfigId() {
        return new Promise((resolve, reject) => {
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.GetActiveConfigIdRequest();
                this.client.getActiveConfigId(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
     ...
     * @returns {Promise<string>} A JSON document.
     */
    getEntityByEntityId(entityId, flags = senzing_1.SzEngineFlags.SZ_ENTITY_DEFAULT_FLAGS) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.GetEntityByEntityIdRequest();
                request.setEntityId(entityId);
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.getEntityByEntityId(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
     ...
     * @returns {Promise<string>} A JSON document.
     */
    getEntityByRecordId(dataSourceCode, recordId, flags = senzing_1.SzEngineFlags.SZ_ENTITY_DEFAULT_FLAGS) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.GetEntityByRecordIdRequest();
                request.setDataSourceCode(dataSourceCode);
                request.setRecordId(recordId);
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.getEntityByRecordId(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
     ...
     */
    getRecord(dataSourceCode, recordId, flags = senzing_1.SzEngineFlags.SZ_RECORD_DEFAULT_FLAGS) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.GetRecordRequest();
                request.setDataSourceCode(dataSourceCode);
                request.setRecordId(recordId);
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.getRecord(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
     ...
     */
    getRecordPreview(recordDefinition, flags = senzing_1.SzEngineFlags.SZ_RECORD_DEFAULT_FLAGS) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.GetRecordPreviewRequest();
                request.setRecordDefinition(recordDefinition);
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.getRecordPreview(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
    ...
    getRedoRecord() {
        return new Promise((resolve, reject) => {
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.GetRedoRecordRequest();
                this.client.getRedoRecord(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
    ...
    getStats() {
        return new Promise((resolve, reject) => {
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.GetStatsRequest();
                this.client.getStats(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
     ...
     * @returns {Promise<string>} A JSON document.
     */
    getVirtualEntityByRecordId(recordKeys, flags = senzing_1.SzEngineFlags.SZ_VIRTUAL_ENTITY_DEFAULT_FLAGS) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
     ...
     * @returns {Promise<string>} A JSON document.
     */
    howEntityByEntityId(entityId, flags = senzing_1.SzEngineFlags.SZ_HOW_ENTITY_DEFAULT_FLAGS) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.HowEntityByEntityIdRequest();
                request.setEntityId(entityId);
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.howEntityByEntityId(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
    ...
    primeEngine() {
        return new Promise((resolve, reject) => {
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.PrimeEngineRequest();
                this.client.primeEngine(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
     ...
     * @returns {Promise<string>} A JSON document.
     */
    processRedoRecord(redoRecord, flags = 0) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.ProcessRedoRecordRequest();
                request.setRedoRecord(redoRecord);
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.processRedoRecord(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
     ...
     * @returns {Promise<string>}
     */
    reevaluateEntity(entityId, flags = 0) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.ReevaluateEntityRequest();
                request.setEntityId(entityId);
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.reevaluateEntity(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
     ...
     */
    reevaluateRecord(dataSourceCode, recordId, flags = 0) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.ReevaluateRecordRequest();
                request.setDataSourceCode(dataSourceCode);
                request.setRecordId(recordId);
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.reevaluateRecord(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
    ...
    reinitialize(configId) {
        return new Promise((resolve, reject) => {
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.ReinitializeRequest();
     ...
     */
    searchByAttributes(attributes, flags = senzing_1.SzEngineFlags.SZ_SEARCH_BY_ATTRIBUTES_DEFAULT_FLAGS, searchProfile = "") {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.SearchByAttributesRequest();
                request.setAttributes((0, szHelpers_1.asString)(attributes));
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                request.setSearchProfile(searchProfile);
                this.client.searchByAttributes(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
     ...
     * @returns A JSON document as Promise<string>.
     */
    whyEntities(entityId1, entityId2, flags = senzing_1.SzEngineFlags.SZ_WHY_ENTITIES_DEFAULT_FLAGS) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.WhyEntitiesRequest();
                request.setEntityId1(entityId1);
                request.setEntityId2(entityId2);
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.whyEntities(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
     ...
     * @returns A JSON document as Promise<string>.
     */
    whyRecordInEntity(dataSourceCode, recordId, flags = senzing_1.SzEngineFlags.SZ_WHY_RECORDS_DEFAULT_FLAGS) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.WhyRecordInEntityRequest();
                request.setDataSourceCode(dataSourceCode);
                request.setRecordId(recordId);
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.whyRecordInEntity(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
     ...
     * @returns A JSON document as Promise<string>.
     */
    whyRecords(dataSourceCode1, recordId1, dataSourceCode2, recordId2, flags = senzing_1.SzEngineFlags.SZ_WHY_RECORDS_DEFAULT_FLAGS) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.WhyRecordsRequest();
                ...
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.whyRecords(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
    ...
    *              for the default recommended flags.
     ...
     */
    whySearch(attributes, entityId, searchProfile = "", flags = senzing_1.SzEngineFlags.SZ_ENTITY_DEFAULT_FLAGS) {
        return new Promise((resolve, reject) => {
            if (!this.client) {
                reject(new SzError_1.SzNoGrpcConnectionError());
                return;
            ...
            this.waitForReady(this.getDeadlineFromNow(), (err) => {
                ...
                const request = new szengine_web_pb_1.WhySearchRequest();
                request.setAttributes(attributes);
                request.setEntityId(entityId);
                request.setSearchProfile(searchProfile);
                request.setFlags((0, szHelpers_1.bigIntToNumber)(flags));
                this.client.whySearch(request, this._metadata, (err, res) => {
                    if (err) {
                        let _err = (0, szHelpers_1.newException)(err);
                        reject(_err);
                        throw _err;
...
exports.SzGrpcWebEngine = SzGrpcWebEngine;
//# sourceMappingURL=szGrpcWebEngine.js.map